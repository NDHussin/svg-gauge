  ...
  var Gauge = (function () {
    ...
    return function Gauge(elem, opts) {
      ...
      var gaugeContainer = elem,
        ...
        displayValuePercent = opts.showValuePercent,
        displayMin = opts.showMinValue,
        displayMax = opts.showMaxValue,
      ...
      function initializeGauge(elem) {
        ...
        var gaugeElement = svg(
          ...
          [
            ...
            svg('g', { class: 'text-container' }, [gaugeValueMin]),
            svg('g', { class: 'text-container' }, [gaugeValueMax]),
            gaugeValuePath,
          ]
        );
      ...
      function updateGauge(theValue, frame) {
        ...
        if (displayValue) {
          if (displayValuePercent) {
            gaugeValueElem.textContent =
              label.call(opts, calculatePercentage(theValue, limit)) + '%';
          } else {
            gaugeValueElem.textContent = label.call(opts, theValue);
          }
        }
        if (displayMin) {
          gaugeValueMin.textContent = label.call(opts, min);
        }
        if (displayMax) {
          gaugeValueMax.textContent = label.call(opts, limit);
        }
